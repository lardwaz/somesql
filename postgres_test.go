...
func TestQuery_AsSQL_Update(t *testing.T) {
	...
	tests := []testCase{
		...
		// Update relations : add
		{
			...
			query:          somesql.NewUpdate(somesql.LangEN).Fields(somesql.NewFields().Add("relations.tags", []string{"a", "b"})),
		...
		},
		{
			...
			query:          somesql.NewUpdate(somesql.LangEN).Fields(somesql.NewFields().Add("relations.tags", []string{"a", "b"}).Add("relations.author", []string{"x"})),
		...
		},
		{
			...
			query:          somesql.NewUpdate(somesql.LangEN).Fields(somesql.NewFields().Add("relations.author", []string{"x"})).Where(somesql.And(somesql.LangEN, "id", "=", "uuid")),
		...
		// // Update relations : remove
		{
			...
			query:          somesql.NewUpdate(somesql.LangEN).Fields(somesql.NewFields().Remove("relations.tags", []string{"a", "b"})),
		...
		},
		{
			...
			query:          somesql.NewUpdate(somesql.LangEN).Fields(somesql.NewFields().Remove("relations.tags", []string{"a", "b"}).Remove("relations.author", []string{"x"})),
		...
		},
		{
			...
			query:          somesql.NewUpdate(somesql.LangEN).Fields(somesql.NewFields().Remove("relations.author", []string{"x"})).Where(somesql.And(somesql.LangEN, "id", "=", "uuid")),
