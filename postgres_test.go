...
func TestQuery_AsSQL_Update(t *testing.T) {
	...
	tests := []testCase{
		...
		},
		{
			...
			expectedSQL:    `UPDATE repo SET "id" = $1, "status" = $2, "data_en" = jsonb_build_object('body', $3::text, 'author_id', $4::text)::JSONB`,
		...
		},
		{
			...
			expectedSQL:    `UPDATE repo SET "id" = $1, "status" = $2, "data_fr" = jsonb_build_object('body', $3::text, 'author_id', $4::text)::JSONB`,
			expectedValues: []interface{}{"1", "published", "body value", "123"},
		},
		{
			...
			expectedSQL:    `UPDATE repo SET "id" = $1, "status" = $2, "data_en" = jsonb_build_object('body', $3::text, 'author_id', $4::text)::JSONB WHERE "id" = $5`,
		...
		},
		{
			...
			expectedSQL:    `UPDATE repo SET "id" = $1, "status" = $2, "data_en" = jsonb_build_object('body', $3::text, 'author_id', $4::text)::JSONB WHERE "data_en"->>'author_id' = $5`,
			expectedValues: []interface{}{"1", "published", "body value", "123", "234"},
		},
